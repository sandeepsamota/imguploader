...
const Create = () => {
  ...
  const imageUpload = async () => {
    ...
    data.append("upload_preset", "kulu_1420");
    data.append("cloud_name", "dumwnul1q");
    const res = await fetch(
      "	https://api.cloudinary.com/v1_1/dumwnul1q/image/upload",
      {
        method: "POST",
        body: data,
      }
  ...
  return (
    <form className="container" onSubmit={(e) => createProduct(e)}>
      <input
        type="text"
        name="name"
        placeholder="Name"
